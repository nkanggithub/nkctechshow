...
<div class="content-asset" style="height:100%">
                <div class="sign" style="height:100%">
                  ...
                  <div id="register" style="width:60%;margin-left:18%">
                    ...
                    <form id="Form1" name="Form1" method="post">
                      <div class="input_bg0">
                        <input name="user_name" value="*孩子姓名" type="text" id="user_name" class="sq">
                      </div>
                      <div class="input_bg0"> <a href="javascript:;" class="btn_ques"></a>
                        <div class="div_answ">
                          <div class="div_answ_t"></div>
                          <p id="answp">请留下您的电话, 以便我们的客服代表与您联系, 也便于您获取我们的活动及优惠讯息短信。我们确保不会将您的信息透露给及其成员公司以外的任何第三方。</p>
                          <div class="div_answ_b"></div>
                        </div>
                        <input name="user_mobile" value="*手机号码" type="text" id="user_mobile" class="sq">
                      </div>
                      <div class="input_bg0"> <a href="javascript:;" class="btn_ques"></a>
                        ...
                        <input name="user_email" value="*家庭住址" type="text" id="user_email" class="sq">
                      </div>
			  ...
			  <img style="width:100%" src="online_0912.png"></a>
			  </body>
			  </html>