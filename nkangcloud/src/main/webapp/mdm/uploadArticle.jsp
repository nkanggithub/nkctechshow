...
<div id="data_model_div" style="z-index:999;" class=""><a href="http://nkctech.duapp.com/mdm/profile.jsp?UID=<%=uid%>"><i class="icon" style="position:absolute;top:20px;left:20px;z-index:100;"><img class="exit" src="http://nkctech.gz.bcebos.com/logo/EXIT1.png" style="width: 30px; height: 30px; "></i></a>	<img style="position:absolute;top:8px;right:20px;z-index:100;" class="HpLogo" src="http://nkctech.gz.bcebos.com/logo/nkclogo.png" alt="Logo"><div style="width:100%;height: 74px;background: white;position:absolute;border-bottom: 4px solid #000000;"></div></div>
<div id='sendR'>
