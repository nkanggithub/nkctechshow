...
MongoDBBasic.updateVisited(uid,currentDate,"RunMaintainMetrics",res.get("HeadUrl"),res.get("NickName"));
...
<html lang="en" class="no-js">
	<head>
		...
		<title>RunMaintainMetrics</title>
	...
	<body>
		...
		<div class="container">
			<div class="content">
				<div class="box">
				<form id="file_upload" name="file_upload" action="../fileUpload/uploadPlatforRelated" enctype="multipart/form-data" method="post">
