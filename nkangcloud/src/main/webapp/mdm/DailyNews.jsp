...
<img onClick="javascript:publishNews();" style='width:70px;cursor:pointer;position: fixed;bottom: 50px;z-index: 1002;' src='http://leshu.bj.bcebos.com/icon/speaker.png'>
<a href="uploadArticle.jsp?UID=<%=uid%>"><img style="width: 70px;cursor:pointer;position: fixed;bottom: 50px;right: 0px;z-index: 1002;" src="http://leshu.bj.bcebos.com/icon/broadcast.png"></a>
