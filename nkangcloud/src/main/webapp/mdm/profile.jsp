...
function mesSend(){
	var selected="<option value='常规沟通'>常规沟通</option>";
	$.ajax({
		 ...
		 success:function(resData){
			 if(resData){
				 for(var i=0;i<resData.length;i++){
					 selected=selected+"<option value='"+data.name+"'>"+data.name+"</option>";
				 }
			 }
		 }
	});
	...
	$("body").append("<div id='sendR'>"
			...
			+"  <div id='commonPush' style='margin-top: 10px;'><div class='rcommon'><p class='bsLabel'>图文类型</p><select class='bsBtn' style='border:1px solid black' id='notificationType'>"+selected+"</select></div>"
