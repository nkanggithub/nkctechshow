...
public class PayUtils {
	...
	public static String generateMchPayNativeRequestURL(String productid){
		...
		String out_trade_no = "nkc"+ timeStamp;
		
		PayQrCode qrCode = new PayQrCode(productid, out_trade_no);
