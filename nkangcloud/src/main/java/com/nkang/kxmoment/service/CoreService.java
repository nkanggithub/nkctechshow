...
//							articlevar.setUrl("http://shenan.duapp.com/mdm/NotificationCenter.jsp?num="+ams.get(i).getNum());
							articlevar.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid="+Constants.APP_ID+"&redirect_uri=http%3A%2F%2F"+Constants.baehost+"%2Fmdm%2FNotificationCenter.jsp?num="+ams.get(i).getNum()+"&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect");
